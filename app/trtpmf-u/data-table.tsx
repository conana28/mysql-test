...
const dataTable = (props: Props) => {
  ...
  useEffect(() => {
    async function fetchData() {
      console.log("Fetch Data [", debouncedGlobalFilter, "]");
      const response = await fetch(
        `/api/wine/${pageIndex}/${pageSize}/${debouncedGlobalFilter}`
      );
    ...
    // if (debouncedGlobalFilter) fetchData()
    fetchData();
  }, [pageIndex, pageSize, debouncedGlobalFilter, userId]);
